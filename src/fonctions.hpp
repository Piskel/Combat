...
enum{COUP_NORMAL, COUP_NORMAL_BAS, COUP_NORMAL_HAUT, COUP_NORMAL_COTE_1, COUP_NORMAL_CHARGE, ROULADE, NUL};

//pour le choix de l'acceuil
enum{RIEN, UN_JOUEUR, DEUX_JOUEURS, QUITTER, RETOUR_JEU, RETOUR_MENU, REJOUER};
