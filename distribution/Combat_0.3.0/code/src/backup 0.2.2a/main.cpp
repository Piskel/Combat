...
int main()
{
	...
	unJoueur.loadFromFile("ressources/img/menus/1-joueur.png");
	unJoueurSelect.loadFromFile("ressources/img/menus/1-joueur-select.png");
	deuxJoueurs.loadFromFile("ressources/img/menus/2-joueurs.png");
	deuxJoueursSelect.loadFromFile("ressources/img/menus/2-joueurs-select.png");
	...
	std::vector<std::string> liste_combattants;

	liste_combattants = chargerPersonnagesDisponibles();

	std::cout << "combattants détectés : ";
	for (unsigned int i = 0; i < liste_combattants.size(); i++)
		std::cout << liste_combattants[i] << " ";
